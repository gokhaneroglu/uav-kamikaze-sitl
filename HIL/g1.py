# İLK DÜZ KAMİKAZE DENEMESİ: Uçak tek tek tüm WP'leri geçip dalış noktasına kadar gelir, 
# ardından Guided moda geçer ve 100 metre irtifada düz bir şekilde 6 saniye uçar. Bu sırada da
# uçağı dalış doğrultusuna oturtur. 6 saniye sonunda dalışa başlar ve 50 metre irtifada toparlanır. 
...
TARGET_FLIGHT_PATH_DOWN_DEG = 42.0  # Dinamik gecikme nedeniyle gerçek yol açısı yaklaşık 45° olur

# Dalış uçuş-yolu açısı PID'i. Pitch hedefinin -8°'ye kadar toparlanabilmesine
# izin verilir; bu sayede 45° aşıldığında uçak daha da dikleşmeye devam etmez.
DIVE_BASE_PITCH_DEG = -34.0
DIVE_PATH_KP = 0.72
DIVE_PATH_KI = 0.004
DIVE_PATH_KD = 0.90
DIVE_PATH_D_FILTER_TAU = 0.30
DIVE_PATH_INTEGRAL_LIMIT = 8.0
DIVE_MIN_PITCH_DEG = -44.0
DIVE_MAX_PITCH_DEG = 2.0
...
DIVE_PITCH_NOSE_DOWN_RATE_DEG_PER_SEC = 25.0
DIVE_PITCH_NOSE_UP_RATE_DEG_PER_SEC = 40.0
...
WP4 = (36.57948879, 36.15393193)
WP5 = (36.57849734, 36.15339268)
VIRTUAL_WP = (36.57884897, 36.15244859)  # WP5 ile dalış WP arasındaki orta nokta
DIVE_TARGET = (36.57939576, 36.15106923)
    ...
    while True:
        ...
        if phase == "DIVE" and loop_now - last_control_send >= CONTROL_PERIOD:
            ...
            if path_angle is None:
                ...
                # Gerçek dalış açısı 45°'den küçükse hata pozitiftir;
