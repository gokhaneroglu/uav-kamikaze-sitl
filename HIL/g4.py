...
CONNECTION = os.getenv("MAVLINK_CONNECTION", "udp:127.0.0.1:14550")
...
HOME = (37.98129904, 41.83968937)
WP1 = (37.98129904, 41.83968937)
WP2 = (37.97994581, 41.83506715)
WP3 = (37.97873450, 41.83457492)
WP4 = (37.97876289, 41.83627973)
WP5 = (37.97967138, 41.83955731)
VIRTUAL_WP = (37.97998574, 41.84050355)  # WP5 -> QR hattında yaklaşık 90 m sonra
DIVE_TARGET = (37.98063700, 41.84246400)  # QR hedef koordinatı
POST_DIVE_WP1 = (37.98171396, 41.84441037)  # Dalış/toparlanma sonrası ilk WP
POST_DIVE_WP2 = (37.98117045, 41.84206587)  # Dalış/toparlanma sonrası ikinci WP
...
# ============================================================
# MİSYON MADDELERİ
# seq 0 HOME, seq 1-5 WP, seq 6 sanal WP, seq 7 dalış konumu,
# seq 8-9 dalış sonrası WP, seq 10 LOITER_UNLIM
# ============================================================
...
mission_items: List[MissionItem] = [
    ...
    nav_item("DALIS_SONRASI_WP1", POST_DIVE_WP1[0], POST_DIVE_WP1[1], 100.0),
    nav_item("DALIS_SONRASI_WP2", POST_DIVE_WP2[0], POST_DIVE_WP2[1], 100.0),
    nav_item(
        "EMNIYET_LOITER",
        DIVE_TARGET[0],
        DIVE_TARGET[1],
...
print(
    "Dalış sonrası: 100 m toparlanma tamamlanınca AUTO ile "
    "DALIS_SONRASI_WP1 -> DALIS_SONRASI_WP2 rotası izlenecek.\n"
)
        ...
        if phase == "RECOVERY" and loop_now - last_control_send >= CONTROL_PERIOD:
            ...
            if (
                ...
                print(
                    ...
                    "Dalış sonrası WP rotasına geçiliyor."
                )

                # Dalış algoritmasına dokunmadan yalnızca toparlanma sonrasında
                # mission akışını yeni iki WP'ye devret. Her iki WP de 100 m'dir.
                set_current_mission(8)
                set_mode("AUTO")
                phase = "AUTO"
                guided_entry_window_seen = False
                print(
                    "Dalış sonrası AUTO başladı | "
                    f"WP1: {POST_DIVE_WP1[0]:.8f}, {POST_DIVE_WP1[1]:.8f} @ 100 m | "
                    f"WP2: {POST_DIVE_WP2[0]:.8f}, {POST_DIVE_WP2[1]:.8f} @ 100 m"
                )
                continue
