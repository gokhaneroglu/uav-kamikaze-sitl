# g1.py dosyası ile benzer şekilde çalışır; yalnızca dalış ve toparlanma mantığı farklıdır. 
# Uçak bu sefer daha dik dalış yapar. 
 
# qr4.py dosyasının jetson versiyonudur.
...
try:
    while True:
        ...
        if phase in ("HOLD", "DIVE", "RECOVERY", "STRAIGHT") and current_alt <= EMERGENCY_RTL_ALT:
            safe_rtl(
                f"Acil irtifa sınırı: {current_alt:.1f} m <= {EMERGENCY_RTL_ALT:.1f} m"
            )
            break
